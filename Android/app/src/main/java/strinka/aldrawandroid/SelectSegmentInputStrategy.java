...
{
	public SelectSegmentInputStrategy(AlDrawController controller)
	{
		super("Select Segment", 2, controller);
	}
	...
	void endHook()
	{
		controller.addSelected(calculateLine(controller.getSelPoint(0), controller.getSelPoint(1)));
	}
