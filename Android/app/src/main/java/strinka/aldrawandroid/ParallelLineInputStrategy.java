...
{
	public ParallelLineInputStrategy(AlDrawController controller)
	{
		super("Find Parallel Line", 3, controller);
	}
	...
	void endHook()
	{
		controller.addLine(calculateLine(controller.getSelPoint(0), controller.getSelPoint(1), controller.getSelPoint(2)));
	}
