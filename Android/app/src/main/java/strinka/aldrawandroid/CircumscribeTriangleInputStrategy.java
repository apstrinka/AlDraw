...
public class CircumscribeTriangleInputStrategy extends InputStrategy
{
	...
	{
		super("Circumscribe Triangle", 3, alDrawController);
	}
	...
	void endHook()
	{
		DPoint center = calculateCenter(controller.getSelPoint(0), controller.getSelPoint(1), controller.getSelPoint(2));
		if (center != null)
		{
			Circle circle = calculateCircle(controller.getSelPoint(0), controller.getSelPoint(1), controller.getSelPoint(2));
