...
{
	public SelectArcInputStrategy(AlDrawController controller)
	{
		super("Select Arc", 3, controller);
	}
	...
	void endHook()
	{
		controller.addSelected(calculateArc(controller.getSelPoint(0), controller.getSelPoint(1), controller.getSelPoint(2)));
	}
