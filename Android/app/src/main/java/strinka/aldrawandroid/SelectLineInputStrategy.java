...
{
	public SelectLineInputStrategy(AlDrawController controller)
	{
		super("Select Line", 2, controller);
	}

	@Override
	void endHook()
	{
		controller.addSelected(new Line(controller.getSelPoint(0), controller.getSelPoint(1)));
	}
