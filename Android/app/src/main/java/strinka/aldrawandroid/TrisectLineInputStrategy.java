...
public class TrisectLineInputStrategy extends InputStrategy
{
	...
	{
		super("Trisect Line", 2, alDrawController);
	}
	...
	void endHook()
	{
		...
		newPoints[0] = calculateFirstPoint(controller.getSelPoint(0), controller.getSelPoint(1));
		newPoints[1] = calculateSecondPoint(controller.getSelPoint(0), controller.getSelPoint(1));
