...
{
	public SelectCircleInputStrategy(AlDrawController alDrawController)
	{
		super("Select Circle", 2, new String[] { "Select center", "Select radius" }, alDrawController);
	}
	...
	void endHook()
	{
		controller.addSelected(calculateCircle(controller.getSel(0), controller.getSel(1)));
	}
