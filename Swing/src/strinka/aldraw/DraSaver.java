...
public class DraSaver
{
	...
	public void save(File file, AlDrawState currentState, CoordinateConverter converter) throws IOException
	{
	...
	private void writeEnclosure(Enclosure enclosure, DataOutputStream out) throws IOException
	{
		out.writeInt(enclosure.getColor().getRed());
		out.writeInt(enclosure.getColor().getGreen());
		out.writeInt(enclosure.getColor().getBlue());
