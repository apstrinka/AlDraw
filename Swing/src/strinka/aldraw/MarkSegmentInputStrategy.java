...
public class MarkSegmentInputStrategy extends InputStrategy
{
	...
	{
		super("Draw Mark Line", 2, new String[] { "Select start", "Select direction" }, alDrawController);
	}
	...
	void endHook()
	{
		controller.addMarkLine(calculateMarkLine(controller.getSel(0), controller.getSel(1)), calculatePoint(controller.getSel(0), controller.getSel(1)));
	}
