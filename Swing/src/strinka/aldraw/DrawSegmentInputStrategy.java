...
{
	public DrawSegmentInputStrategy(AlDrawController alDrawController)
	{
		super("Draw Segment", 2, new String[] { "Select start", "Select end" }, alDrawController);
	}
	...
	void endHook()
	{
		controller.addSegment(calculateLine(controller.getSel(0), controller.getSel(1)));
	}
