...
{
	public TangentLineInputStrategy(AlDrawController alDrawController)
	{
		super("Find Tangent Line", 2, new String[] { "Select center", "Select radius" }, alDrawController);
	}
	...
	void endHook()
	{
		controller.addLine(calculateLine(controller.getSel(0), controller.getSel(1)));
	}
