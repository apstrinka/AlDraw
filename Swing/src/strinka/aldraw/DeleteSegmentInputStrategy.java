...
{
	public DeleteSegmentInputStrategy(AlDrawController alDrawController)
	{
		super("Delete Segment", 2, new String[] { "Select start", "Select end" }, alDrawController);
	}
	...
	void endHook()
	{
		controller.removeSegment(calculateLine(controller.getSel(0), controller.getSel(1)));
	}
