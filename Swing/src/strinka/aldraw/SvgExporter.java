...
public class SvgExporter
{
	...
	// TODO: This method has a lot of its own coordinate conversion going on.
	// Put that stuff where it belongs, CoordinateConverter
	public void exportSVG(File file, AlDrawState currentState, CoordinateConverter converter) throws IOException
	{
		...
		for (int i = 0; i < currentState.getNumEnclosures(); i++)
		{
			...
			//TODO: write the path!
			fw.write("\" fill=\"rgb(" + e.getColor().getRed() + "," + e.getColor().getGreen() + "," + e.getColor().getBlue() +")\" ");
