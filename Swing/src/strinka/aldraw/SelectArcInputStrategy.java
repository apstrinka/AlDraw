...
public class SelectArcInputStrategy extends InputStrategy
{
	public SelectArcInputStrategy(AlDrawController alDrawController)
	{
		super("Select Arc", 3, new String[] { "Select center", "Select start", "Select end" }, alDrawController);
	}
	...
	void endHook()
	{
		controller.addSelected(calculateArc(controller.getSel(0), controller.getSel(1), controller.getSel(2)));
	}
