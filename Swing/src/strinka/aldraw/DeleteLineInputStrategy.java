...
{
	public DeleteLineInputStrategy(AlDrawController alDrawController)
	{
		super("Delete Line", 2, new String[] { "Select first point", "Select second point" }, alDrawController);
	}

	@Override
	void endHook()
	{
		controller.removeLine(new Line(controller.getSel(0), controller.getSel(1)));
	}
