...
{
	public DeleteCircleInputStrategy(AlDrawController alDrawController)
	{
		super("Delete Circle", 2, new String[] { "Select center", "Select radius" }, alDrawController);
	}
	...
	void endHook()
	{
		controller.removeCircle(calculateCircle(controller.getSel(0), controller.getSel(1)));
	}
