...
{
	public DeleteRayInputStrategy(AlDrawController alDrawController)
	{
		super("Delete Ray", 2, new String[] { "Select start", "Select direction" }, alDrawController);
	}

	@Override
	void endHook()
	{
		controller.removeRay(new Ray(controller.getSel(0), controller.getSel(1)));
	}
