...
{
	public DrawLineInputStrategy(AlDrawController alDrawController)
	{
		super("Draw Line", 2, new String[] { "Select first point", "Select second point" }, alDrawController);
	}

	@Override
	void endHook()
	{
		controller.addLine(new Line(controller.getSel(0), controller.getSel(1)));
	}
