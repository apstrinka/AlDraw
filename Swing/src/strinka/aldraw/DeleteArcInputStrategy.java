...
{
	public DeleteArcInputStrategy(AlDrawController alDrawController)
	{
		super("Delete Arc", 3, new String[] { "Select center", "Select start", "Select end" }, alDrawController);
	}
	...
	void endHook()
	{
		controller.removeArc(calculateArc(controller.getSel(0), controller.getSel(1), controller.getSel(2)));
	}
