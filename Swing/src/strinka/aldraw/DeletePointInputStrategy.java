...
{
	public DeletePointInputStrategy(AlDrawController alDrawController)
	{
		super("Delete Point", 1, new String[] { "Select point" }, alDrawController);
	}

	@Override
	void endHook()
	{
		controller.removePoint(controller.getSel(0));
	}
